                        ...
                        <div class="">
                          <div class="fadeIn animated mb-4">
                                <div class="text-capitalize">
                                  <h2 align="center" class="text-capitalize">E-Arsip DIKBUD <br>Kabupaten Kolaka</h2>
                                    
                                    <div class=""><div><center><img src="assets/images/kolaka.png" width="120" height="130" /></center></div>
                        <div><br>
                        <center>Selamat datang di Sistem Arsip Surat Berbasis Web. Sistem ini merupakan sistem yang digunakan untuk mencatat surat masuk dan surat keluar dan disertai dengan bukti upload berkas</center></div>
                    </div>
                              </div>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group text-center">
                                        <button class="btn btn-primary btn-block btn-md" type="submit"> 
                                            <i class="load-indicator">
                                                <clip-loader :loading="loading" color="#ffffffff" size="20px"></clip-loader> 
                                            </i>
